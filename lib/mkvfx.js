					...
					if ("type" in repository && url !== "") {
						...
						if (type == "git") {
                            ...
                            if (platform === "windows") {
                                ...
                                var command = '(New-Object System.Net.WebClient).DownloadFile("' + url + '","' + dir_path + '")';
                                var childProcess = exec('powershell -Command "' + command + '"',
                                                        function(err,sysout,syserr) {
                                                            console.dir(sysout);
                                                        });
                                childProcess.stdin.end();
                                // TODO got the tgz, use 7z to untar/unzip it
                            }
                            else {
