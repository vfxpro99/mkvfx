...
var platform = "windows"; // "osx";
var platform_compiler = "vs2015"; // "clang";
					...
					if ("type" in repository && url !== "") {
						...
						if (type == "git") {
                            ...
                            if (platform === "windows") {
                                ...
                                var command = '(New-Object System.Net.WebClient).DownloadFile("' +
                                http://blog.commandlinekungfu.com +
                                '","' +
                                c:\downloadedfile.html
                                + '")';
                                var childProcess = exec('powershell -Command "' + command + '"', function(err,sysout,syserr) {
                                    console.dir(sysout);
                                });
